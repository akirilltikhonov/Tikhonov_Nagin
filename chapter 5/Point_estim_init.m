...
%% FILTER INIT
Point_estim.filter.sko_pixels = 2;          % rms observations noise in pixels
...
%% Dksi3
Point_estim.filter.ksi_x3_xcam_dispersion =  [0.001; 0.001; 0.001].^2;
Point_estim.filter.ksi_x3_qcam_dispersion =  [0.00001; 0.00001; 0.00001; 0.00001].^2;
Point_estim.filter.ksi_x3_xn_dispersion = 0.001^2;
