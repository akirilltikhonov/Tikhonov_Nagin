...
Point_estim.filter.x3_xn_all(1:3*200, 1) = nan;     % aray for a priori/starting keypoints coordinates
...
Point_estim.filter.initial_uncertainty_dispersion_x3_xn_all(1:3*200, 1) = nan;           %aray for uncertainty xn 
