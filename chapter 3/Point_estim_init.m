...
%Dx1
Point_estim.filter.xoc = [1; 1; 1];         %a priori/starting coordinates of special point
Point_estim.filter.xcam = [1; 1; 0];        %a priori/starting coordinates of camera
...
Point_estim.filter.initial_uncertainty_xcam = 10;    %initial uncertainty of camera's coordinates
