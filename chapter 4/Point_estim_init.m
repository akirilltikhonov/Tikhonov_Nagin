...
Point_estim.filter.Dx2 = diag([Point_estim.filter.initial_uncertainty_sko_x2, Point_estim.filter.initial_uncertainty_sko_x2, Point_estim.filter.initial_uncertainty_sko_x2, Point_estim.filter.initial_uncertainty_sko_x2]).^2;
...
Point_estim.filter.ksi_x2_sko = sqrt((Point_estim.filter.ksi1_x2_sko)^2 + (Point_estim.filter.ksi2_x2_sko)^2 + (Point_estim.filter.ksi3_x2_sko)^2);
