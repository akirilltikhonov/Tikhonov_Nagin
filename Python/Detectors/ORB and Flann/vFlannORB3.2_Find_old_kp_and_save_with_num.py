...
img1 = cv2.imread("source\Mi5S\query1.jpg", cv2.IMREAD_GRAYSCALE)   #queryImage

cap = cv2.VideoCapture('source\Mi5S\VID1.7.mp4')                     #video frame
